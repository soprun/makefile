...
ifeq ($(PROJECT_NAME),)
$(error 'You need to set the PROJECT_NAME environment variable')
endif

ifeq ($(SUPPORTED_COMMANDS),)
$(error 'You need to set the SUPPORTED_COMMANDS variable')
endif
